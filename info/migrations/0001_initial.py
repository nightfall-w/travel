# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2019-04-25 20:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groggery', models.ManyToManyField(blank=True, to='info.Groggery', verbose_name='酒店')),
                ('scenic', models.ManyToManyField(blank=True, to='info.Scenic', verbose_name='相册')),
            ],
            options={
                'verbose_name': '旅游项目',
